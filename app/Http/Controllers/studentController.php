...
class studentController extends Controller {
	...
	*/
	public function create()
	{
		...
		'general_register_number' => 'required',
		'uid_number' => 'required',
	...
	if ($validator->fails())
	{
		...
		$student->general_register_number= Input::get('general_register_number');
		$student->uid_number= Input::get('uid_number');
		$student->adhar_card_number= Input::get('adhar_card_number');
        $student->admissiondate= Input::get('admissiondate');
...
public function view($id)
{
	...
	'Student.localGuardian','Student.parmanentAddress','Student.general_register_number','Student.uid_number','Student.adhar_card_number','student.admissiondate')
