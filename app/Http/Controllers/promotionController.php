	...
	if ($validator->fails()) {
		...
		else
		{
			...
			foreach($realPromot as $rpromt) {
				...
				$newStudent->general_register_number=$studentIno->general_register_number;
				$newStudent->uid_number=$studentIno->uid_number;
				$newStudent->adhar_card_number=$studentIno->adhar_card_number;
				$newStudent->admissiondate=$studentIno->admissiondate;
