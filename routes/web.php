...
Route::post('/fees/paid-list','feesController@postPaidList');
Route::get('/fees/paid-list','feesController@getPaidList');
...
Route::get('/fees/report/std/{regiNo}/{billNo}','feesController@reportstd');
