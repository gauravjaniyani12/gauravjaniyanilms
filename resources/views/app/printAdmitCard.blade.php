 ...
 <table class="bg2">
   <tr><td>
    Applicant's Copy
       ...
       <td><strong>Class {{$data->class}} Admission Exam &nbsp;(Session:{{$data->session}})</strong></td>
  <td >
    <strong></strong>
  </td>
</tr>
...
<tr><td></td></tr>
  <tr>
    ...
    <td style="vertical-align:top;width:100%" >
       Signature Of Authority&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This Addmission Application is Electronically Produced.
    </td>

  </tr>
 </table>
 <!--   <p style="color:red;text-align:center">Admission test will be held on xxth XXXX at Campus 1.</p>   -->
<p style="text-align:right;margin-right:20px;">Software develop by- &nbsp;Gaurav Janiyani</p>
</div>
</body>
</html>
