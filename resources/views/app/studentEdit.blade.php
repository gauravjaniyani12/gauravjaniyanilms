            ...
            <div class="col-md-4">
              <div class="form-group ">
                <label for="admissiondate">Admission Date</label>
                   <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                       <input type="text" value="{{$student->admissiondate}}"  class="form-control datepicker" name="admissiondate" required  data-date-format="dd/mm/yyyy">
                    </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                    <input value="{{$student->general_register_number}}" type="text" class="form-control" required name="general_register_number" placeholder="General Register Number">
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                    <input value="{{$student->uid_number}}" type="text" class="form-control"  name="uid_number" placeholder="UID Number" required>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                    <input value="{{$student->adhar_card_number}}" type="text" class="form-control" required name="adhar_card_number" placeholder="Adhar Card Number">
                  </div>
                </div>
              </div>
