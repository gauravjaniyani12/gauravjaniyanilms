              ...
              <div class="col-md-9">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control select2-list" required name="regiNo" id="regiNo">
                        @foreach($students as $student)
                          <option value="{{ $student->regiNo }}">{{ $student->name }}</option>
                        @endforeach
                    </select>
                    <!-- {{ Form::select('regiNo',$students,null, array('class'=>'form-control select2-list','required' =>'required') )}} -->
                  </div>
                </div>
              </div>
              <div class="col-md-3">
...
<!--                     {{ Form::select('code',$books,null,['id' => 'bookCode','class'=>'form-control select2-list'])}} -->
                    <select class="form-control select2-list" required name="bookCode" id="bookCode">
