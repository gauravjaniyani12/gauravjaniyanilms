               ...
               <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                  <div class="col-md-2"></div>
                                <div class="col-md-3">
                                  <strong class="text-info font-16" >Shift :</strong>
                                </div>
                                <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-2"></div>
                    <div class="col-md-3">
                      <strong class="text-info font-16" >Admission Date:</strong>
                    </div>
                    <div class="col-md-7">
                      <label>{{$student->admissiondate}} </label>
                    </div>
                  </div>
                </div>
                                                <div class="row">
                                              <div class="col-md-12">
                                                  <div class="col-md-2"></div>
                                                <div class="col-md-3">
                                                  <strong class="text-info font-16" >General Register Number :</strong>
                                                </div>
                                                <div class="col-md-7">
                                                  <label>{{$student->general_register_number}} </label>
                                                </div>
                                                </div>
                                                </div>
                                              ...
                                              <div class="col-md-12">
                                                  <div class="col-md-2"></div>
                                                <div class="col-md-3">
                                                  <strong class="text-info font-16" >UID Number :</strong>
                                                </div>
                                                <div class="col-md-7">
                                                  <label>{{$student->uid_number}} </label>
                                                </div>
                                                </div>
                                                </div>
                                              ...
                                              <div class="col-md-12">
                                                  <div class="col-md-2"></div>
                                                <div class="col-md-3">
                                                  <strong class="text-info font-16" >Adhar Card Number :</strong>
                                                </div>
                                                <div class="col-md-7">
                                                  <label>{{$student->adhar_card_number}} </label>
                                                </div>
                                                </div>
                                                </div>
